...
public class SingleUserStep extends BaseSteps{
    ...
    public void ıSendAGetRequestUserEndpoint() {
        ...
        response = given().contentType("application/json").auth().preemptive().basic(jiraUserName, jiraToken).get(userEndpoint + "?accountId=63d64f5528cddcc7076fbafd");
    ...
    public void userInformationsAreMustBeTrue() throws Exception{
        ...
        Assertions.assertThat(actualProduct.getAvatarUrls().getA1616()).isEqualTo(expectedProduct.getAvatarUrls().getA1616());
        Assertions.assertThat(actualProduct.getAvatarUrls().getA2424()).isEqualTo(expectedProduct.getAvatarUrls().getA2424());
        Assertions.assertThat(actualProduct.getAvatarUrls().getA3232()).isEqualTo(expectedProduct.getAvatarUrls().getA3232());
        Assertions.assertThat(actualProduct.getAvatarUrls().getA4848()).isEqualTo(expectedProduct.getAvatarUrls().getA4848());
        ...
        Assertions.assertThat(actualProduct.getGroups().getItems().length).isEqualTo(expectedProduct.getGroups().getItems().length);
        Assertions.assertThat(actualProduct.getApplicationRoles().getItems().length).isEqualTo(expectedProduct.getApplicationRoles().getItems().length);
        Assertions.assertThat(actualProduct.getApplicationRoles().getSize()).isEqualTo(expectedProduct.getApplicationRoles().getSize());
    ...
    public void ıSendAGetRequestWithWrongAccountId() {
        ...
        response = given().contentType("application/json").auth().preemptive().basic(jiraUserName, jiraToken).get(userEndpoint + "?accountId=63d64f5528cddcc7076fba");
        LOGGER.info("I send a Get request user endpoint");
    }
